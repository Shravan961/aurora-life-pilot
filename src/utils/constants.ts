export const GROQ_API_KEY = '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';
...
export const GEMINI_API_KEY = 'AIzaSyB1ZBFMSVc9G5kypdkw91im9o4Rd3dBARw';
...
export const STORAGE_KEYS = {
  ...
  AI_MEMORY: 'aiMemory',
  VOICE_JOURNALS: 'voiceJournals',
  BOT_PERSONAS: 'botPersonas'
};
